...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    ...
    #  -we4702
    set(MSVC_W4_WARNINGS "-we4100 -we4101 -we4189 -we4700 -we4701 -we4705 -we4706 -we4710 -we4722 -we4723")
...
# special definitions
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -DQT_NO_DEBUG -DQT_NO_DEBUG_OUTPUT")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -DQT_NO_DEBUG -DQT_NO_DEBUG_OUTPUT")
