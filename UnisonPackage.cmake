...
set(PROJECT_APPLICATION_NAME "UnisonCore Launcher")
...
if(APPLE)
    ...
    set(MACOSX_BUNDLE_RESOURCES "${EXECUTABLE_OUTPUT_PATH}/${PROJECT_NAME}.app/Contents/Resources")
...
if(WIN32)
    ...
    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_APPLICATION_NAME} ${PROJECT_VERSION}")
